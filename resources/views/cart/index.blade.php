...
@section('title', 'Keranjang Belanja — Luxe Furniture')
            ...
            <div class="bg-white rounded-2xl border border-warm-100 p-6 shadow-sm sticky top-24">
                ...
                <div class="space-y-3 mb-5">
                    ...
                    <div class="flex justify-between text-sm text-warm-600">
                        <span class="line-clamp-1 flex-1">{{ $item['title'] }} × {{ $item['qty'] }}</span>
                        <span class="font-semibold ml-3 shrink-0">Rp {{ number_format($item['price'] * $item['qty'], 0, ',', '.') }}</span>
                    </div>
                    @endforeach
                </div>
                ...
                <a href="{{ route('checkout.index') }}" class="btn-primary w-full mt-6 py-4 text-base">
                    Lanjut ke Checkout
                ...
                <a href="{{ route('products.index') }}" class="btn-ghost w-full mt-3 py-3 text-sm justify-center">
                    ← Lanjut Belanja
                </a>
            </div>
        </div>
