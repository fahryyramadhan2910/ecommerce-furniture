...
@section('title', 'Luxe Furniture — Premium Home Furniture')
@section('meta_description', 'Koleksi furnitur premium pilihan untuk rumah impian Anda. Kualitas terbaik, desain elegan, harga terjangkau.')
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="max-w-2xl animate-slide-up">
            ...
            <div class="flex flex-wrap items-center gap-4">
                <a href="{{ route('products.index') }}" class="btn-primary text-base px-8 py-4 shadow-lg shadow-primary-900/30">
                    Jelajahi Koleksi
            ...
            <div class="card-product group">
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <span class="text-primary-700 font-bold text-lg">{{ $product->formatted_price }}</span>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a href="{{ route('products.index', ['category' => $cat['key']]) }}"
               class="group relative overflow-hidden rounded-2xl shadow-lg aspect-[4/5] block">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <h3 class="text-white font-serif text-2xl font-bold">{{ $cat['label'] }}</h3>
                    <p class="text-warm-300 text-sm mt-1">{{ $cat['desc'] }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center p-8 rounded-2xl bg-white/5 hover:bg-white/10 transition border border-white/10">
                <div class="text-5xl mb-5">{{ $feature['icon'] }}</div>
                <h3 class="font-serif text-xl font-bold mb-3">{{ $feature['title'] }}</h3>
                <p class="text-warm-400 leading-relaxed">{{ $feature['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
